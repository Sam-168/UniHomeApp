package RegisterForm.za.ac.cput.prtgui.HomePage.LandLord;

import javax.swing.*;
import java.awt.*;
import RegisterForm.za.ac.cput.prtgui.HomePage.Background.CirclePanel;
import RegisterForm.za.ac.cput.prtgui.HomePage.HomePage; // Import your HomePage
import za.ac.cput.prtgui.GUI;

/**
 *
 * @author jadar
 */
public class LandLordLogin extends JFrame  {
    ...
    public LandLordLogin() {
        ...
        forgotLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                JOptionPane.showMessageDialog(frame, "Redirecting to reset password...");
                // TODO: Replace with new ResetPassword() screen later
            }
        });
        ...
        backLabel.setFont(new Font("Arial", Font.BOLD, 11));
        backLabel.setForeground(Color.BLUE);
        backLabel.setBounds(120, 240, 100, 20);
        backLabel.setCursor(new Cursor(Cursor.HAND_CURSOR));
        backLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            @Override
            public void mouseClicked(java.awt.event.MouseEvent e) {
                frame.dispose(); // close login window
                new GUI(); // open welcome page
            }
        });
